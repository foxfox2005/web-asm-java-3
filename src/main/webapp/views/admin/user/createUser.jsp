...
<section class="section-content">
  <div class="container">
    ...
    <main class="row mb-5">
      <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/usersManager/create">
        ...
        <div class="mb-3">
          ...
          <input type="text"
                 class="form-control ${not empty requestScope.nameViolations ? 'is-invalid' : (not empty requestScope.user.id ? 'is-valid' : '')}"
                 id="id"
                 name="id"
        ...
        <div class="mb-3">
          ...
          <input type="date"
                 ...
                 id="birthday"
                 name="birthday"
                 value="${requestScope.user.birthday}" required>
        </div>
        <div class="mb-3">
          ...
          <div class="form-check d-inline-block">
            <input class="form-check-input"
                   ...
                   name="gender"
                   id="gender-false"
                   value="false" ${!requestScope.user.gender ? 'checked' : ''}
                   required>
          ...
          <div class="form-check d-inline-block me-4">
            <input class="form-check-input"
                   ...
                   name="gender"
                   id="gender-true"
                   value="true" ${requestScope.user.gender ? 'checked' : ''}
                   required>
        ...
        <div class="mb-3">
          ...
          <div class="form-check d-inline-block">
            <input class="form-check-input"
                   ...
                   name="role"
                   id="role-employee"
                   value="0" ${!requestScope.user.role ? 'checked' : ''}
                   required>
          ...
          <div class="form-check d-inline-block me-4">
            <input class="form-check-input"
                   ...
                   name="role"
                   id="role-admin"
                   value="true" ${requestScope.user.role ? 'checked' : ''}
                   required>
        ...
        <a class="btn btn-danger mb-3"
           href="${pageContext.request.contextPath}/admin/usersManager"
           role="button"
           onclick="return confirm('Bạn có muốn hủy?')">Hủy</a>
      </form>
    </main>
  </div>
</section>
